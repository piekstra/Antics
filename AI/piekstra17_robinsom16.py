...
class AIPlayer(Player):
    ...
    def __init__(self, inputPlayerId):
        ...
        # Does not happen when learning is complete
    ...
    # gMatrixMult
    # Description: Multiplies two matrices and returns the 
    #   resulting matrix after applying the g function
    #
    # Parameters:
    #   self - The object pointer
    #   matrix1 - The first matrix
    ...
    #
    # Notes:
    #   Does the same thing as matrixMult except all of the
    #   values in the resulting matrix have the g function
    #   applied to them.
    #
    # Return: The matrix resulting from multiplying matrix1 with matrix2
    #   and applying the g funciton
    #
    ...
    #
    # Notes:
    #   This does the same thing as getBestMove except that it 
    #   finds both the neural network and evaluateState function
    #   values of a resulting state and uses this information
    #   to apply backpropogation to train the network.
    #
    #   It also dumps the weight matrices to a file if the neural
    #   network produced a certain number of consecutive "acceptable"
    #   (accurate) results.
    #
    # Parameters:
    #   self - The object pointer
    #   currentState - The state to expand for possible moves
    #
    # Return: The highest scoring move (according to evaluateState)
    #
    def getBestMoveWithPropogation(self, currentState):
        ...
        for move in listAllLegalMoves(currentState):
            ...
            # perform backpropogation to train the neural network
    ...
    ## 
    # theMatrix
    # Description: Given an array representation of a state,
    #   performs matrix operations to apply the weights on 
    #   inputs and carry inputs/outputs through to the "end"
    #   of the network. The final result is a single value 
    #   that represents the value of the state.
    #
    # Parameters:
    #   self - The object pointer
    #   stateArray - The current state of the game as an array
    #       of floats ranging from 0.0 to 1.0
    #
    # Return: The value of the state on a scale of 0.0 to 1.0
    # where 0.0 is a loss and 1.0 is a victory
    #
    def theMatrix(self, stateArray):
        # multiply input by hidden layer weights
        # note that stateArray is formatted as a 2D array
        #   so that matrix mult works (it requires 2D arrays)
        hiddenLayerValues = self.gMatrixMult([stateArray], self.hiddenLayerWeights)
        
        # add a bias value (constant) for the next layer
        hiddenLayerValues[0].append(self.bias)
        
        # save the hidden layer's outputs
        self.hiddenLayerOutputs = hiddenLayerValues
        
        # mult hidden layer values by output layer weights
        ...
        # return the value of the state (the output of the network)
